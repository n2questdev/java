...
//    "notes": ""
	...
	public String toString() {
		return "Credential::" + System.lineSeparator() +
				"------------" + System.lineSeparator() +
				"expirationdate: " + getExpirationdate() + System.lineSeparator() + 
				"credentialid: " + getCredentialid() + System.lineSeparator() + 
				"startdate: " + getStartdate() + System.lineSeparator() + 
				"credentialnumber: " + getCredentialnumber() + System.lineSeparator() +
				"status: " + getStatus() + System.lineSeparator() + 
				"attachmentcount: " + getAttachmentcount() + System.lineSeparator() + 
				"notes: " + getNotes();
	}
//	Date expirationdate;
//	Long credentialid;
